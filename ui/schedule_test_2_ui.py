...
################################################################################
## Form generated from reading UI file 'schedule_test_2.ui'
##
...
class Ui_schedule_window(object):
    def setupUi(self, schedule_window):
        ...
        schedule_window.resize(1165, 708)
...
"")
        ...
        self.top_logo_2.setMaximumSize(QSize(201, 63))
        font = QFont()
        ...
        self.horizontalLayout_5.addWidget(self.top_logo_2)

        self.horizontalSpacer_2 = QSpacerItem(40, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)

        self.horizontalLayout_5.addItem(self.horizontalSpacer_2)

        self.schedule_all_remove_bnt = QPushButton(schedule_window)
        self.schedule_all_remove_bnt.setObjectName(u"schedule_all_remove_bnt")
        self.schedule_all_remove_bnt.setMinimumSize(QSize(70, 30))
        font1 = QFont()
...
"")
        ...
        self.horizontalLayout_5.addWidget(self.schedule_all_remove_bnt)

        self.horizontalSpacer_3 = QSpacerItem(352, 20, QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Minimum)
        ...
        self.camera_view_name_1 = QLabel(schedule_window)
...
"border: 1px solid rgb(119, 118, 123);")
        ...
        self.camera_view_1 = QLabel(schedule_window)
...
"color: rgb(255, 255, 255);")
        ...
        self.camera_view_name_2 = QLabel(schedule_window)
...
"border: 1px solid rgb(119, 118, 123);")
        ...
        self.camera_view_2 = QLabel(schedule_window)
...
"color: rgb(255, 255, 255);")
        ...
        self.camera_view_name_3 = QLabel(schedule_window)
...
"border: 1px solid rgb(119, 118, 123);")
        ...
        self.camera_view_3 = QLabel(schedule_window)
...
"color: rgb(255, 255, 255);")
        ...
        self.camera_view_name_4 = QLabel(schedule_window)
...
"border: 1px solid rgb(119, 118, 123);")
        ...
        self.camera_view_4 = QLabel(schedule_window)
...
"color: rgb(255, 255, 255);")
        ...
        self.camera_view_name_5 = QLabel(schedule_window)
...
"border: 1px solid rgb(119, 118, 123);")
        ...
        self.camera_view_5 = QLabel(schedule_window)
...
"color: rgb(255, 255, 255);")
        ...
        self.camera_view_name_6 = QLabel(schedule_window)
...
"border: 1px solid rgb(119, 118, 123);")
        ...
        self.camera_view_6 = QLabel(schedule_window)
...
"color: rgb(255, 255, 255);")
        ...
        self.camera_view_name_7 = QLabel(schedule_window)
...
"border: 1px solid rgb(119, 118, 123);")
        ...
        self.camera_view_7 = QLabel(schedule_window)
...
"color: rgb(255, 255, 255);")
        ...
        self.camera_view_name_8 = QLabel(schedule_window)
...
"border: 1px solid rgb(119, 118, 123);")
        ...
        self.camera_view_8 = QLabel(schedule_window)
...
"color: rgb(255, 255, 255);")
        ...
        self.camera_view_name_9 = QLabel(schedule_window)
...
"border: 1px solid rgb(119, 118, 123);")
        ...
        self.camera_view_9 = QLabel(schedule_window)
...
"color: rgb(255, 255, 255);")
        ...
        self.camera_view_name_10 = QLabel(schedule_window)
...
"border: 1px solid rgb(119, 118, 123);")
        ...
        self.camera_view_10 = QLabel(schedule_window)
...
"color: rgb(255, 255, 255);")
        ...
        self.camera_view_name_11 = QLabel(schedule_window)
...
"border: 1px solid rgb(119, 118, 123);")
        ...
        self.camera_view_11 = QLabel(schedule_window)
...
"color: rgb(255, 255, 255);")
        ...
        self.camera_view_name_12 = QLabel(schedule_window)
...
"border: 1px solid rgb(119, 118, 123);")
        ...
        self.camera_view_12 = QLabel(schedule_window)
...
"color: rgb(255, 255, 255);")
        ...
        self.camera_view_name_13 = QLabel(schedule_window)
...
"border: 1px solid rgb(119, 118, 123);")
        ...
        self.camera_view_13 = QLabel(schedule_window)
...
"color: rgb(255, 255, 255);")
        ...
        self.camera_view_name_14 = QLabel(schedule_window)
...
"border: 1px solid rgb(119, 118, 123);")
        ...
        self.camera_view_14 = QLabel(schedule_window)
...
"color: rgb(255, 255, 255);")
        ...
        self.camera_view_name_15 = QLabel(schedule_window)
...
"border: 1px solid rgb(119, 118, 123);")
        ...
        self.camera_view_15 = QLabel(schedule_window)
...
"color: rgb(255, 255, 255);")
        ...
        self.camera_view_name_16 = QLabel(schedule_window)
...
"border: 1px solid rgb(119, 118, 123);")
        ...
        self.camera_view_16 = QLabel(schedule_window)
...
"color: rgb(255, 255, 255);")
        ...
        self.widget_3.setMaximumSize(QSize(354, 16777215))
...
"")
        ...
        self.horizontalSpacer_6 = QSpacerItem(25, 20, QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Minimum)

        self.horizontalLayout_7.addItem(self.horizontalSpacer_6)

        self.horizontalLayout_8 = QHBoxLayout()
        self.horizontalLayout_8.setObjectName(u"horizontalLayout_8")
        self.event_label = QLabel(self.widget_3)
...
"background-color: rgba(191, 64, 64, 0);")
        ...
        self.horizontalLayout_8.addWidget(self.event_label)

        self.event_box = QComboBox(self.widget_3)
...
"")
        ...
        self.horizontalLayout_8.addWidget(self.event_box)
        ...
        self.time_label.setMinimumSize(QSize(44, 0))
        self.time_label.setMaximumSize(QSize(43, 57))
...
"background-color: rgba(191, 64, 64, 0);")
        ...
        self.time_box = QComboBox(self.widget_3)
        self.time_box.addItem("")
        self.time_box.addItem("")
        self.time_box.setObjectName(u"time_box")
        self.time_box.setMinimumSize(QSize(70, 0))
        self.time_box.setMaximumSize(QSize(112, 16777215))
        self.time_box.setFont(font5)
        self.time_box.setStyleSheet(u"color: rgb(255, 255, 255);\n"
"background-color: rgb(13, 16, 23);\n"
"selection-background-color: rgb(53, 132, 228);\n"
"")
        self.time_box.setMinimumContentsLength(0)

        self.horizontalLayout_9.addWidget(self.time_box)
        ...
        self.check_box_sun = QPushButton(self.widget_3)
...
"")
        ...
        self.check_box_sun.setIconSize(QSize(15, 15))
        self.check_box_sun.setCheckable(True)
        self.check_box_sun.setChecked(False)
        self.check_box_sun.setFlat(True)

        self.horizontalLayout_10.addWidget(self.check_box_sun)

        self.check_box_mon = QPushButton(self.widget_3)
...
"")
        ...
        self.check_box_mon.setIconSize(QSize(15, 15))
        self.check_box_mon.setCheckable(True)
        self.check_box_mon.setChecked(False)
        self.check_box_mon.setFlat(True)

        self.horizontalLayout_10.addWidget(self.check_box_mon)

        self.check_box_tue = QPushButton(self.widget_3)
...
"")
        ...
        self.check_box_tue.setIconSize(QSize(15, 15))
        self.check_box_tue.setCheckable(True)
        self.check_box_tue.setChecked(False)
        self.check_box_tue.setFlat(True)

        self.horizontalLayout_10.addWidget(self.check_box_tue)

        self.check_box_wed = QPushButton(self.widget_3)
...
"")
        ...
        self.check_box_wed.setIconSize(QSize(15, 15))
        self.check_box_wed.setCheckable(True)
        self.check_box_wed.setChecked(False)
        self.check_box_wed.setFlat(True)

        self.horizontalLayout_10.addWidget(self.check_box_wed)

        self.check_box_thu = QPushButton(self.widget_3)
...
"")
        ...
        self.check_box_thu.setIconSize(QSize(15, 15))
        self.check_box_thu.setCheckable(True)
        self.check_box_thu.setChecked(False)
        self.check_box_thu.setFlat(True)

        self.horizontalLayout_10.addWidget(self.check_box_thu)

        self.check_box_fri = QPushButton(self.widget_3)
...
"")
        ...
        self.check_box_fri.setIconSize(QSize(15, 15))
        self.check_box_fri.setCheckable(True)
        self.check_box_fri.setChecked(False)
        self.check_box_fri.setFlat(True)

        self.horizontalLayout_10.addWidget(self.check_box_fri)

        self.check_box_sat = QPushButton(self.widget_3)
...
"")
        ...
        self.check_box_sat.setIconSize(QSize(15, 15))
        self.check_box_sat.setCheckable(True)
        self.check_box_sat.setChecked(False)
        self.check_box_sat.setFlat(True)

        self.horizontalLayout_10.addWidget(self.check_box_sat)
        ...
        self.horizontalSpacer_4 = QSpacerItem(229, 20, QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Minimum)
        ...
        self.event_add_bnt = QPushButton(self.widget)
        self.event_add_bnt.setObjectName(u"event_add_bnt")
        sizePolicy1.setHeightForWidth(self.event_add_bnt.sizePolicy().hasHeightForWidth())
        self.event_add_bnt.setSizePolicy(sizePolicy1)
        self.event_add_bnt.setMinimumSize(QSize(53, 27))
        self.event_add_bnt.setMaximumSize(QSize(53, 27))
        font6 = QFont()
        font6.setFamilies([u"NanumBarunGothic"])
        font6.setPointSize(10)
        self.event_add_bnt.setFont(font6)
        self.event_add_bnt.setCursor(QCursor(Qt.PointingHandCursor))
        self.event_add_bnt.setStyleSheet(u"background-color: rgb(30, 195, 55);\n"
"color: rgb(255, 255, 255);\n"
"border-radius: 10px;\n"
"")

        self.horizontalLayout_18.addWidget(self.event_add_bnt)

        self.event_del_bnt = QPushButton(self.widget)
        self.event_del_bnt.setObjectName(u"event_del_bnt")
        self.event_del_bnt.setMinimumSize(QSize(53, 27))
        self.event_del_bnt.setMaximumSize(QSize(53, 16777215))
        font7 = QFont()
        font7.setFamilies([u"Sans"])
        font7.setPointSize(10)
        self.event_del_bnt.setFont(font7)
        self.event_del_bnt.setCursor(QCursor(Qt.PointingHandCursor))
        self.event_del_bnt.setStyleSheet(u"background-color: rgb(237, 51, 59);\n"
"color: rgb(255, 255, 255);\n"
"border-radius: 10px;\n"
"\n"
"")

        self.horizontalLayout_18.addWidget(self.event_del_bnt)
        ...
        self.event_table = QTableWidget(self.widget)
        ...
        if (self.event_table.rowCount() < 1):
            self.event_table.setRowCount(1)
        __qtablewidgetitem3 = QTableWidgetItem()
        self.event_table.setItem(0, 0, __qtablewidgetitem3)
        __qtablewidgetitem4 = QTableWidgetItem()
        self.event_table.setItem(0, 1, __qtablewidgetitem4)
        __qtablewidgetitem5 = QTableWidgetItem()
        self.event_table.setItem(0, 2, __qtablewidgetitem5)
        self.event_table.setObjectName(u"event_table")
        self.event_table.setMinimumSize(QSize(8, 0))
        self.event_table.setMaximumSize(QSize(354, 16777215))
...
"    background-color: rgb(30, 195, 55); /* \uc120\ud0dd\ub41c \uc140\uc758 \ubc30\uacbd\uc0c9 */\n"
"    color: rgb(255, 255, 255);\n"
"\n"
"}\n"
"\n"
...
"")
        ...
        self.event_table.setDragDropOverwriteMode(False)
        self.event_table.setSelectionMode(QAbstractItemView.SelectionMode.MultiSelection)
        ...
        self.event_table.horizontalHeader().setMinimumSectionSize(53)
        self.event_table.horizontalHeader().setDefaultSectionSize(80)
        ...
        self.verticalLayout_19.addWidget(self.event_table)
        ...
        self.camera_save_bnt_2 = QPushButton(schedule_window)
        self.camera_save_bnt_2.setObjectName(u"camera_save_bnt_2")
        sizePolicy1.setHeightForWidth(self.camera_save_bnt_2.sizePolicy().hasHeightForWidth())
        self.camera_save_bnt_2.setSizePolicy(sizePolicy1)
        self.camera_save_bnt_2.setMinimumSize(QSize(76, 39))
        self.camera_save_bnt_2.setMaximumSize(QSize(76, 39))
        self.camera_save_bnt_2.setFont(font6)
        self.camera_save_bnt_2.setCursor(QCursor(Qt.PointingHandCursor))
        self.camera_save_bnt_2.setStyleSheet(u"background-color: rgb(30, 195, 55);\n"
"color: rgb(255, 255, 255);\n"
"border-radius: 19px;\n"
"")

        self.horizontalLayout_12.addWidget(self.camera_save_bnt_2)

        self.schedule_close_bnt_2 = QPushButton(schedule_window)
        self.schedule_close_bnt_2.setObjectName(u"schedule_close_bnt_2")
        self.schedule_close_bnt_2.setMinimumSize(QSize(76, 39))
        self.schedule_close_bnt_2.setMaximumSize(QSize(76, 39))
        self.schedule_close_bnt_2.setFont(font7)
        self.schedule_close_bnt_2.setCursor(QCursor(Qt.PointingHandCursor))
        self.schedule_close_bnt_2.setStyleSheet(u"background-color: rgb(237, 51, 59);\n"
"color: rgb(255, 255, 255);\n"
"border-radius: 19px;\n"
"\n"
"")

        self.horizontalLayout_12.addWidget(self.schedule_close_bnt_2)
        ...
        self.check_box_sun.setDefault(False)
        self.check_box_mon.setDefault(False)
        self.check_box_tue.setDefault(False)
        self.check_box_wed.setDefault(False)
        self.check_box_thu.setDefault(False)
        self.check_box_fri.setDefault(False)
        self.check_box_sat.setDefault(False)
    ...
    def retranslateUi(self, schedule_window):
        ...
        self.event_box.setItemText(0, QCoreApplication.translate("schedule_window", u"\uc804\uccb4", None))
        self.event_box.setItemText(1, QCoreApplication.translate("schedule_window", u"\uce68\uc785", None))
        self.event_box.setItemText(2, QCoreApplication.translate("schedule_window", u"\ubc30\ud68c", None))
        self.event_box.setItemText(3, QCoreApplication.translate("schedule_window", u"\uc4f0\ub7ec\uc9d0", None))
        self.event_box.setItemText(4, QCoreApplication.translate("schedule_window", u"\uc2f8\uc6c0", None))
        self.event_box.setItemText(5, QCoreApplication.translate("schedule_window", u"\ubc29\ud654", None))

        self.time_label.setText(QCoreApplication.translate("schedule_window", u"\uc2dc\uac04", None))
        self.time_box.setItemText(0, QCoreApplication.translate("schedule_window", u"\uc8fc\uac04", None))
        self.time_box.setItemText(1, QCoreApplication.translate("schedule_window", u"\uc57c\uac04", None))

        self.check_box_sun.setText(QCoreApplication.translate("schedule_window", u" \uc77c", None))
        self.check_box_mon.setText(QCoreApplication.translate("schedule_window", u" \uc6d4", None))
        self.check_box_tue.setText(QCoreApplication.translate("schedule_window", u" \ud654", None))
        self.check_box_wed.setText(QCoreApplication.translate("schedule_window", u" \uc218", None))
        self.check_box_thu.setText(QCoreApplication.translate("schedule_window", u" \ubaa9", None))
        self.check_box_fri.setText(QCoreApplication.translate("schedule_window", u" \uae08", None))
        self.check_box_sat.setText(QCoreApplication.translate("schedule_window", u" \ud1a0", None))
        self.event_add_bnt.setText(QCoreApplication.translate("schedule_window", u"\ucd94\uac00", None))
        self.event_del_bnt.setText(QCoreApplication.translate("schedule_window", u"\uc0ad\uc81c", None))
        ___qtablewidgetitem = self.event_table.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(QCoreApplication.translate("schedule_window", u"\ubc88\ud638", None));
        ___qtablewidgetitem1 = self.event_table.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("schedule_window", u"\uc885\ub958", None));
        ___qtablewidgetitem2 = self.event_table.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("schedule_window", u"\uc2dc\uac04", None));

        __sortingEnabled = self.event_table.isSortingEnabled()
        self.event_table.setSortingEnabled(False)
        ___qtablewidgetitem3 = self.event_table.item(0, 0)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("schedule_window", u"1", None));
        ___qtablewidgetitem4 = self.event_table.item(0, 1)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("schedule_window", u"\uce68\uc785", None));
        ___qtablewidgetitem5 = self.event_table.item(0, 2)
        ___qtablewidgetitem5.setText(QCoreApplication.translate("schedule_window", u"\uc6d4, \uc8fc\uac04", None));
        self.event_table.setSortingEnabled(__sortingEnabled)

        self.camera_save_bnt_2.setText(QCoreApplication.translate("schedule_window", u"\uc801\uc6a9", None))
        self.schedule_close_bnt_2.setText(QCoreApplication.translate("schedule_window", u"\ub2eb\uae30", None))
    # retranslateUi
