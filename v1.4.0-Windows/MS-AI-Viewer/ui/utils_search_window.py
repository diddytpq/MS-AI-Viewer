    ...
    def mouseDoubleClickEvent(self, event):
        ...
        try:
            ...
            if self.video_info is not None:
                ...
                url = f'http://{self.instance.parent.HOST}:{self.instance.parent.PORT}/get-par-video'
                ...
                if response.status_code == 200:
                    ...
                    self.instance.search_page_worker.ImageUpdated.connect(lambda image, viewer=viewer: self.instance.parent.ShowCamera(viewer, image))
...
class SearchDialog(QDialog):
    def __init__(self, parent=None):
        ...
        for camera_name, camera_viewer in self.search_page_camera_view_list.items():
            ...
            if camera_name in self.parent.camera_view_list.keys():
                frame = self.parent.camera_img_temp[camera_name]
    ...
    def get_par_search_info(self):
        ...
        url = f'http://{self.parent.HOST}:{self.parent.PORT}/get-par-search-info'
    ...
    def search_viewer_playback(self, click):
        try:
            ...
            if selected_indexes:
                ...
                data = {"msg" : video_file_name}
                url = f'http://{self.parent.HOST}:{self.parent.PORT}/get-search-video'
